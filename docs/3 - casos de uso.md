...
7. Principais Regras de Negócio relacionadas a Produtos Químicos:
...
7. Principais Regras de Negócio relacionadas as Cargas Químicas:
* Uma carga química deve possuir quantidade maior que zero informada no momento do registro.
* Uma carga química deve possuir um responsável técnico informado no momento do registro.
